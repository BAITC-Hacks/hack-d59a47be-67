...
**Текущий статус:** проанализированы ТЗ и стартовый кит, подготовлены архитектура, контракты и план реализации. Работают локальная подготовка/аудит данных и проверки артефактов. Веб-приложение, БД, HTTP API и реальный вызов LLM ещё не реализованы. Fixtures не являются ответами реальной модели.
